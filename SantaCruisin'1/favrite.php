...
<body>
    ...
    <div class="tm-hero d-flex justify-content-center align-items-center" data-parallax="scroll" data-image-src="img/restaurant/favrite1.jpg"></div>
    <div class="container-fluid tm-container-content tm-mt-60">
        <div class="row mb-4">
            <h2 class="col-12 tm-text-primary">Favrite Hideout</h2>
        </div>
        <div class="row tm-mb-90">            
            <div class="col-xl-8 col-lg-7 col-md-6 col-sm-12">
                <a href="img/restaurant/favrite2.jpg"><img src="img/restaurant/favrite2.jpg" alt="Image" class="img-fluid"></a>
            </div>
            <div class="col-xl-4 col-lg-5 col-md-6 col-sm-12">
                <div class="tm-bg-gray tm-video-details">
                    ...
                    <div class="mb-4">
                        ...
                        <p>Location: Banahaw, Sta. Cruz, Marinduqe</p>
                        <p>Photo Credit: Favrite Hideout Fb Page</p>
                    </div>
        ...
        <div class="row mb-3 tm-gallery">
            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 mb-5">
                <figure class="effect-ming tm-video-item">
                    <a href="img/restaurant/favrite.jpg"><img src="img/restaurant/favrite.jpg" alt="Image" class="img-fluid"></a>                 
                </figure>
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 mb-5">
                <figure class="effect-ming tm-video-item">
                    <a href="img/restaurant/favrite1.jpg"><img src="img/restaurant/favrite1.jpg" alt="Image" class="img-fluid"></a>                 
                </figure>
                <div class="d-flex justify-content-between tm-text-gray">
                    <span class="tm-text-gray-light">00/00/0000</span>
                </div>
