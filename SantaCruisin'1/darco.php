...
<body>
    ...
    <nav class="navbar navbar-expand-lg">
        <div class="container-fluid">
            <a class="navbar-brand" href="swimmingpool.php">
    ...
    <div class="container-fluid tm-container-content tm-mt-60">
        <div class="row mb-4">
            <h2 class="col-12 tm-text-primary">Villa D' Arco</h2>
        </div>
        <div class="row tm-mb-90">            
            <div class="col-xl-8 col-lg-7 col-md-6 col-sm-12">
                <a href="img/pool/daro.jpg"><img src="img/pool/daro.jpg" alt="Image" class="img-fluid"></a>
            </div>
            <div class="col-xl-4 col-lg-5 col-md-6 col-sm-12">
                <div class="tm-bg-gray tm-video-details">
                    <p class="mb-4">
                         I want a swimming pool! OOpps! swimming pool? you're in the right spot homie! NOW! choose and find here the Swimming pool Resort that you want!!
                    </p>          
                    <p>
                    ...
                    <div class="mb-4">
                        ...
                        <p>Location: Banahaw, Santa Cruz, Marinduqe</p>
                        <p>Photo Credit: Villa D' Arco</p>
                    </div>
        ...
        <div class="row mb-3 tm-gallery">
            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 mb-5">
                <figure class="effect-ming tm-video-item">
                    <a href="img/pool/darco1.jpg"><img src="img/pool/darco1.jpg" alt="Image" class="img-fluid"></a>                 
                </figure>
