...
<body>
    ...
    <div class="tm-hero d-flex justify-content-center align-items-center" data-parallax="scroll" data-image-src="img/restaurant/mamanes.jpg"></div>

    <div class="container-fluid tm-container-content tm-mt-60">
        <div class="row mb-4">
            <h2 class="col-12 tm-text-primary">Pull over Mamanes Dampa </h2>
        </div>
        <div class="row tm-mb-90">            
            <div class="col-xl-8 col-lg-7 col-md-6 col-sm-12">
                <a href="img/restaurant/mamanes.jpg"><img src="img/restaurant/mamanes.jpg" alt="Image" class="img-fluid"></a>
            </div>
            <div class="col-xl-4 col-lg-5 col-md-6 col-sm-12">
                <div class="tm-bg-gray tm-video-details">
                    <p class="mb-4">
                         Too hungry and don't know where to eat? well i got homie. a lot of restaurant choices here!
                    </p>          
                    <p>
                    ...
                    <div class="mb-4">
                        ...
                        <p>Location: Matalaba, Santa Cruz, Marinduque</p>
                        <p>Photo Credit: Mamanes FB Page</p>
                    </div>
...
<div class="d-flex align-items-center">
  ...
  <label class="dislike-button">
    ...
    <i class="far fa-thumbs-down"></i>
        ...
        <div class="row mb-3 tm-gallery">
            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 mb-5">
                <figure class="effect-ming tm-video-item">
                    <a href="img/restaurant/mamanes1.jpg"><img src="img/restaurant/mamanes1.jpg" alt="Image" class="img-fluid"></a>                 
                </figure>
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 mb-5">
                <figure class="effect-ming tm-video-item">
                    <a href="img/restaurant/mamanes2.jpg"><img src="img/restaurant/mamanes2.jpg" alt="Image" class="img-fluid"></a>                 
                </figure>
                <div class="d-flex justify-content-between tm-text-gray">
                    <span class="tm-text-gray-light">00/00/0000</span>
                </div>
        ...
        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 mb-5">
                <figure class="effect-ming tm-video-item">
                    <img src="img/restaurant/favrite1.jpg" alt="Image" class="img-fluid">
                    <figcaption class="d-flex align-items-center justify-content-center">
                        <h2>Favrite Hideout</h2>
                        <a href="favrite.php">View more</a>
                    </figcaption>                    
                </figure>
                <div class="d-flex justify-content-between tm-text-gray">
                    <span class="tm-text-gray-light">00/00/0000</span>
        ...
        <div class="container-fluid tm-container-small">
            <div class="row">
                <div class="col-lg-6 col-md-12 col-12 px-5 mb-5">
                    <h3 class="tm-text-primary mb-4 tm-footer-title">About SantaCruizn'</h3>
            ...
            <div class="row">
                <div class="col-lg-8 col-md-7 col-12 px-5 mb-3">
                    Copyright 2023 SantaCruizn'. All rights reserved.
                </div>
