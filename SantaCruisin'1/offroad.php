...
<body>
    ...
    <div class="tm-hero d-flex justify-content-center align-items-center" data-parallax="scroll" data-image-src="img/offroadfront.jpg"></div>

    <div class="container-fluid tm-container-content tm-mt-60">
        <div class="row mb-4">
            <h2 class="col-12 tm-text-primary">Makulapnit Road</h2>
        </div>
        <div class="row tm-mb-90">            
            <div class="col-xl-8 col-lg-7 col-md-6 col-sm-12">
                <a href="img/offroad/makulapnit1.jpg"><img src="img/offroad/makulapnit1.jpg" alt="Image" class="img-fluid"></a>
            </div>
            <div class="col-xl-4 col-lg-5 col-md-6 col-sm-12">
                <div class="tm-bg-gray tm-video-details">
                    <p class="mb-4">
                         Some adventure and you love mother earth nature? this one is the best for you, Makulapnit Road. you can ride a bike here if you're a mountain biker.
                    </p>          
                    <p>
                    ...
                    <div class="mb-4">
                        ...
                        <p>Location: Makulapnit, Santa Cruz, Marinduqe</p>
                        <p>Photo Credit: Kenith Natal </p>
                    </div>
        ...
        <div class="row mb-3 tm-gallery">
            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 mb-5">
                <figure class="effect-ming tm-video-item">
                    <a href="img/offroad/makulapnit.jpg"><img src="img/offroad/makulapnit.jpg" alt="Image" class="img-fluid"></a>                 
                </figure>
