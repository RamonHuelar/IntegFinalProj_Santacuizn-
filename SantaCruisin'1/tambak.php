...
<body>
    ...
    <nav class="navbar navbar-expand-lg">
        <div class="container-fluid">
            <a class="navbar-brand" href="beaches.php">
    ...
    <div class="tm-hero d-flex justify-content-center align-items-center" data-parallax="scroll" data-image-src="img/beaches/bathala.jpg"></div>
    <div class="container-fluid tm-container-content tm-mt-60">
        <div class="row mb-4">
            <h2 class="col-12 tm-text-primary">Tambak Beach</h2>
        </div>
        <div class="row tm-mb-90">            
            <div class="col-xl-8 col-lg-7 col-md-6 col-sm-12">
                <a href="img/beaches/bathala.jpg"><img src="img/beaches/bathala.jpg" alt="Image" class="img-fluid"></a>
            </div>
            <div class="col-xl-4 col-lg-5 col-md-6 col-sm-12">
                <div class="tm-bg-gray tm-video-details">
                    ...
                    <div class="mb-4">
                        ...
                        <p>Location: Gaspar Island, Gasan, Marinduqe</p>
                        <p>Photo Credit: Seller Nolos and Padz Henry  </p>
                    </div>
        ...
        <div class="row mb-3 tm-gallery">
            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 mb-5">
                <figure class="effect-ming tm-video-item">
                    <a href="img/beaches/bathala1.jpg"><img src="img/beaches/bathala1.jpg" alt="Image" class="img-fluid"></a>                 
                </figure>
