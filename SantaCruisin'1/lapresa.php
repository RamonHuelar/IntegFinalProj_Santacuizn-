...
<body>
    ...
    <nav class="navbar navbar-expand-lg">
        <div class="container-fluid">
            <a class="navbar-brand" href="camp.php">
    ...
    <div class="container-fluid tm-container-content tm-mt-60">
        <div class="row mb-4">
            <h2 class="col-12 tm-text-primary">La Presa</h2>
        </div>
        <div class="row tm-mb-90">            
            <div class="col-xl-8 col-lg-7 col-md-6 col-sm-12">
                <a href="img/campsight/taytay.jpg"><img src="img/campsight/taytay.jpg" alt="Image" class="img-fluid"></a>
            </div>
            <div class="col-xl-4 col-lg-5 col-md-6 col-sm-12">
                <div class="tm-bg-gray tm-video-details">
                    <p class="mb-4">
                         Want to be away in toxic environment? or Overnight with mother nature? this spots are the best for you.
                    </p>          
                    <p>
                    ...
                    <div class="mb-4">
                        ...
                        <p>Location: Brgy. Taytay, Sta. Cruz, Marinduqe</p>
                        <p>Photo Credit: Mio Requillas  </p>
                    </div>
        ...
        <div class="row mb-3 tm-gallery">
            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 mb-5">
                <figure class="effect-ming tm-video-item">
                    <a href="img/campsight/taytay1.jpg"><img src="img/campsight/taytay1.jpg" alt="Image" class="img-fluid"></a>                 
                </figure>
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 mb-5">
                <figure class="effect-ming tm-video-item">
                    <a href="img/campsight/taytay2.jpg"><img src="img/campsight/taytay2.jpg" alt="Image" class="img-fluid"></a>                 
                </figure>
                <div class="d-flex justify-content-between tm-text-gray">
                    <span class="tm-text-gray-light">00/00/0000</span>
                </div>
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 mb-5">
                <figure class="effect-ming tm-video-item">
                    <a href="img/campsight/taytay3.jpg"><img src="img/campsight/taytay3.jpg" alt="Image" class="img-fluid"></a>                 
                </figure>
                <div class="d-flex justify-content-between tm-text-gray">
                    <span class="tm-text-gray-light">00/00/0000</span>
                </div>
        ...
        <div class="container-fluid tm-container-small">
            <div class="row">
                <div class="col-lg-6 col-md-12 col-12 px-5 mb-5">
                    ...
                    where attached the location of the image that has been captured.
                    </p>
                </div>
